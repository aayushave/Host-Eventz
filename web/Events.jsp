    ...
    <header><nav class="navbar navbar-default navbar-fixed-top probootstrap-navbar">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.jsp" title="Event | An Event Site">Event</a>
        </div>
            ...
            <div class="row">
              <div class="col-md-8 col-md-offset-2">
                <div class="probootstrap-slider-text text-center">
                  <h1 class="probootstrap-heading">Events You Can Register For !</h1>
...
String sql="select eid,ename,imageurl,redirecturl from table2 where eid='"+eid[i]+"'";
       Class.forName("com.mysql.jdbc.Driver");
          ...
          <div class="col-md-5 col-sm-6 col-xs-6 probootstrap-animate">
            <a href="<%=reurl%>" class="probootstrap-team">
              <img src="<%=imgurl%>" alt="Free Bootstrap Template by uicookies.com" class="img-responsive img-rounded">
              <div class="probootstrap-team-info">
                <h3><%=ename%> <span class="position"><%=eida%></span></h3>
              </div>
            </a>
          </div>
            ...
            <div class="probootstrap-modal-flex">
              ...
              <div class="probootstrap-modal-content">
                <form action="#" class="probootstrap-form">
                  ...
                  <div class="form-group">
                    <input type="password" class="form-control" name="pass" laceholder="Password">
                  </div> 
              ...
              <div class="probootstrap-modal-content">
                <form action="/jsplogin/INSERT2.jsp" method="post" class="probootstrap-form">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="password" class="form-control" placeholder="Type Password" name="pass">
                  </div>
                    <div class="form-group">
                        <input type="password" class="form-control" placeholder="Re-type Password" name="pass">
                  </div>
                  <div class="form-group clearfix mb40">
                    <label for="remember" class="probootstrap-remember"><input type="checkbox" id="remember"> Remember Me</label>
                    <a href="#" class="probootstrap-forgot">Forgot Password?</a>
